...
$(".owl-carousel").owlCarousel({
  ...
  nav: true,
  dots: true,
  navText: ["<img class='left-arrow' src='images/left-arrow.png'>", "<img class='right-arrow' src='images/right-arrow.png'>"],
  responsive: {
    0: {
      items: 1,
      nav: true
...
var gridItems = document.querySelectorAll('.portfolio__grid-item'); // When the user scrolls the page, execute myFunction
...
var options = {
  strings: ['На пути веб-разработки', 'Творчество', 'Созидание'],
  typeSpeed: 40,
  backSpeed: 40,
  loop: true
};
var typed = new Typed('.extract', options);